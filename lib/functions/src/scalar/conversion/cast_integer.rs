...
mod tests {
    ...
    async fn test_cast_integer_normal() {
        ...
        | {decimal=1000.0000000000000000}                                | {integer=10}               |
        | {string={value: String1, language: }}                          | {null=}                    |
        | {string={value: 01, language: }}                               | {integer=1}                |
        | {blank_node=test1}                                             | {null=}                    |
        | {integer=2605}                                                 | {integer=2605}             |
        | {float=26.05}                                                  | {integer=26}               |
    ...
    #[tokio::test]
    async fn test_cast_integer_fast_path_integer() {
        let encoding = Arc::new(TypedValueEncoding::default());
        let test_vector =
    ...
    #[tokio::test]
    async fn test_cast_integer_fast_path_decimal() {
        let encoding = Arc::new(TypedValueEncoding::default());
        let test_vector =
        ...
        | input                           | xsd:integer(?table?.input) |
        +---------------------------------+----------------------------+
        | {decimal=1000.0000000000000000} | {integer=1000}             |
        +---------------------------------+----------------------------+
        "
        )
    }
    ...
    #[tokio::test]
    async fn test_cast_integer_fast_path_float() {
        let encoding = Arc::new(TypedValueEncoding::default());
        let test_vector =
    ...
    #[tokio::test]
    async fn test_cast_integer_fast_path_string() {
        let encoding = Arc::new(TypedValueEncoding::default());
        let test_vector =
    ...
    #[tokio::test]
    async fn test_cast_integer_fast_path_boolean() {
        let encoding = Arc::new(TypedValueEncoding::default());
        let test_vector =
