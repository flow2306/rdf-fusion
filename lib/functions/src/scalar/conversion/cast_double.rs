...
mod tests {
    ...
    async fn test_cast_double_normal() {
        ...
        | {decimal=1000.0000000000000000}                                | {double=10.0}               |
        | {string={value: String1, language: }}                          | {null=}                     |
        | {string={value: 01, language: }}                               | {double=1.0}                |
        | {blank_node=test1}                                             | {null=}                     |
        | {integer=2605}                                                 | {double=2605.0}             |
        | {float=26.05}                                                  | {double=26.049999237060547} |
    ...
    #[tokio::test]
    async fn test_cast_double_fast_path_integer() {
        let encoding = Arc::new(TypedValueEncoding::default());
        let test_vector =
    ...
    #[tokio::test]
    async fn test_cast_double_fast_path_decimal() {
        let encoding = Arc::new(TypedValueEncoding::default());
        let test_vector =
        ...
        | input                           | xsd:double(?table?.input) |
        +---------------------------------+---------------------------+
        | {decimal=1000.0000000000000000} | {double=1000.0}           |
        +---------------------------------+---------------------------+
        "
        )
    }
    ...
    #[tokio::test]
    async fn test_cast_double_fast_path_float() {
        let encoding = Arc::new(TypedValueEncoding::default());
        let test_vector =
    ...
    #[tokio::test]
    async fn test_cast_double_fast_path_string() {
        let encoding = Arc::new(TypedValueEncoding::default());
        let test_vector =
    ...
    #[tokio::test]
    async fn test_cast_double_fast_path_boolean() {
        let encoding = Arc::new(TypedValueEncoding::default());
        let test_vector =
